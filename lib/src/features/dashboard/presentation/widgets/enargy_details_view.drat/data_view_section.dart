...
List<List<EnergyDataItem>> get customDataList {
  return [
    // Day 1
    [
      EnergyDataItem(title: "Data A", color: Colors.blue, data: "3000.50 (30%)", cost: "36000 ৳"),
      EnergyDataItem(title: "Data B", color: Colors.lightBlue, data: "72000.50 (36%)", cost: "5260000 ৳"),
      EnergyDataItem(title: "Data C", color: Colors.purple, data: "6500.36 (84%)", cost: "5700000 ৳"),
      EnergyDataItem(title: "Data D", color: Colors.orange, data: "6600.26 (37%)", cost: "357000 ৳"),
    ],
    // Day 2
    [
      EnergyDataItem(title: "Data A", color: Colors.blue, data: "3100.50 (31%)", cost: "36500 ৳"),
      EnergyDataItem(title: "Data B", color: Colors.lightBlue, data: "73000.50 (37%)", cost: "5270000 ৳"),
      EnergyDataItem(title: "Data C", color: Colors.purple, data: "6700.36 (85%)", cost: "5710000 ৳"),
      EnergyDataItem(title: "Data D", color: Colors.orange, data: "6700.26 (38%)", cost: "358000 ৳"),
    ],
    // Day 3 (optional)
    [
      EnergyDataItem(title: "Data A", color: Colors.blue, data: "3200.50 (32%)", cost: "37000 ৳"),
      EnergyDataItem(title: "Data B", color: Colors.lightBlue, data: "74000.50 (38%)", cost: "5280000 ৳"),
      EnergyDataItem(title: "Data C", color: Colors.purple, data: "6800.36 (86%)", cost: "5720000 ৳"),
      EnergyDataItem(title: "Data D", color: Colors.orange, data: "6800.26 (39%)", cost: "359000 ৳"),
    ],
  ];
}
          ...
          Expanded(
            child: SingleChildScrollView(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: commonRadioButon("Custom Date Data", !showTodayData),
                      ),
              ...
              onSearch: (range) {
                ...
                // Here you can update your customDataList based on the selected range
              },
            ),
